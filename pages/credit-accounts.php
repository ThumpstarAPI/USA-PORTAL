...
<div class="container py-5 " id="credit-accounts">
    <div class="row">
        ...
        <div class="col-12"> 
        <p > Credit Earned:<span id ="credit-earned"> </span> <span> <a href="sold-units.php"> View Credit Earned</a></p>
        <p > Credit Paid:<span id ="credit-paid"> </span> </p>
        <p > Parts Credit Owing :<span id ="credit-owing"> </span> </p>
        </div>
            ...
            <p style="float:right;  margin-right:50px;" > Credit Paid: <span id="credit-paid-p"> </span> </p>
            </div>
    </div>
</div>
</section>
